...
const Game = () => {
  ...
  const handleGameStart = (path) => {
    // Only call backend for modes that need it
    if (path === "/game/bot" || path === "/game/random") {
      console.log("TODO: Add backend logic here for bot/random.");
      // Add navigate(`/game/bot/${gameId}`) when implemented
    } else {
      navigate(path); // Simply redirect for /game/friend
    }
  };
