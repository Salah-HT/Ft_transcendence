...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'ft_transcendence_db'),
        'USER': os.getenv('POSTGRES_USER', 'ft_transcendence'),
        'PASSWORD': os.getenv('POSTGRES_PASSWORD', 'ft_transcendence@42'),
...
CORS_ALLOWED_ORIGINS = [
    ...
    "http://authen-service:8000",
    "http://game-service:8001",
]
...
ASGI_APPLICATION = 'authen_service.asgi.application'
